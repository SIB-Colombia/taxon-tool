	...
	<header class="sib">
		...
		<nav>
			<div class="share_icons">
				...
				<span></span>
				<a title="<?= Yii::t('app', 'Español'); ?>" href="<?php echo Yii::app()->createUrl("taxon/busqueda", array("lang"=>"es"));?>">ESP</a>
				<span></span>
				<a title="<?= Yii::t('app', 'Ingles'); ?>" href="<?php echo Yii::app()->createUrl("taxon/busqueda", array("lang"=>"en"));?>">ENG</a>
			</div>
		</nav>
	</header> <!-- Fin header -->
	...
	<div id="cocoon" >
		<div id="container">
			<div id="content">
				<div id="panes">
				<div>
					<h2><?= Yii::t('app', 'Servicio De Resolución Taxonómica Y De LSIDs'); ?></h2>
					<?=$content;?>
				</div>
				</div>
			</div>
